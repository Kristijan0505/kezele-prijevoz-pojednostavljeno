...
const ContactFormSection: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://hook.eu2.make.com/jsto7rawdxb1db4y2eydpoofbonoo3fk', {
        method: 'POST',
        headers: {
      ...
      setSubmitError('Došlo je do greške. Molimo pokušajte ponovno ili nas kontaktirajte telefonom.');
    } finally {
        ...
        <div className="max-w-2xl mx-auto animate-[fadeInUp_0.7s_ease-in-out_0.3s_both]">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              {/* Error message */}
              {submitError && (
                <div className="bg-primary-red text-background-white p-4 rounded-lg mb-6 flex items-center animate-[slideInUp_0.5s_ease-in-out]">
